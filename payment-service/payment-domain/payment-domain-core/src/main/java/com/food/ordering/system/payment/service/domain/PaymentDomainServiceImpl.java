...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(Payment payment,
        ...
        validateCreditEntity(payment, creditEntry, failureMessages);
    ...
    private void validateCreditEntity(Payment payment,
                                      CreditEntry creditEntry,
                                      List<String> failureMessages) {
        if (payment.getPrice().isGreaterThan(creditEntry.getTotalCreditAmount())) {
            String errorMessage = "Customer with id: %s doesn t have enough credit for payment!"
                    .formatted(payment.getCustomerId().getValue());
    ...
    private void validateCreditHistory(CreditEntry creditEntry,
        ...
        if (totalCreditHistory.isGreaterThan(totalDebitHistory)) {
            String errorMessage = "Customer with id: %s doesn t have enough credit according to credit history"
                    .formatted(creditEntry.getCustomerId().getValue());
            log.error(errorMessage);
            failureMessages.add(errorMessage);
        }
