...
/**
 * Слушатель кафка отвечающий за одобрения ресторана
 */
@Slf4j
@Component
public class RestaurantApprovalResponseKafkaListener implements KafkaConsumer<RestaurantApprovalResponseAvroModel> {

    private final RestaurantApprovalResponseMessagesListener restaurantApprovalResponseMessagesListener;
    private final OrderMessagingDataMapper orderMessagingDataMapper;

    @Autowired
    public RestaurantApprovalResponseKafkaListener(RestaurantApprovalResponseMessagesListener restaurantApprovalResponseMessagesListener,
                                                   OrderMessagingDataMapper orderMessagingDataMapper) {
        this.restaurantApprovalResponseMessagesListener = restaurantApprovalResponseMessagesListener;
